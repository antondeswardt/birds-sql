DROP TABLE SIGHTING_BIRD_LIST_MAPPINGS;
DROP TABLE SIGHTINGS;
DROP TABLE BIRD_LIST_LOCATION_MAPPINGS;
DROP TABLE BIRD_LISTS;
DROP TABLE LOCATION_MAPPINGS;
DROP TABLE LOCATIONS;
DROP TABLE BIRD_FAMILY_MAPPINGS;
DROP TABLE BIRD_FAMILYS;
DROP TABLE BIRDS;
DROP TABLE BIRDERS;
